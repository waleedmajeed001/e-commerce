...
export default function Trending() {
  ...
  const handleViewAll = () => {
    window.location.href = '/Viewall/favorate'; // Forces a refresh before navigating
  };
  ...
  return (
    <div className="bg-black w-screen p-6 sm:p-12 dark:bg-gray-900 relative">
      ...
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-semibold text-center text-gray-100 w-full">Favorite</h1>
        <button
